...
function getRelatedLinks(page: AlternativePageData) {
  ...
  return [
    { href: "/alternatives", label: "Alternatives Hub", description: "Return to all alternative guides." },
    { href: "/platforms", label: "Platform Guides", description: "Compare major platform styles." },
    ...alternativeLinks,
    ...platformLinks,
    ...bestLinks,
    ...compareLinks,
    { href: "/categories", label: "Categories", description: "Browse live model categories by practical need." },
  ];
}

export function AlternativePageLayout({ page }: { page: AlternativePageData }) {
  return (
    <main className="min-h-screen text-white">
      ...
      <section className="mx-auto grid max-w-7xl gap-5 px-4 pb-16 pt-5">
        ...
        <LinkGrid title="Related alternatives, platforms, and decision pages" links={getRelatedLinks(page)} />
      </section>
    </main>
  );
}
