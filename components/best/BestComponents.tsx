...
export function DecisionCard({
  ...
  return (
    <div className="rounded-3xl border border-[#7C5CFF]/24 bg-white/[0.035] p-6 shadow-[0_24px_70px_rgba(0,0,0,0.24)]">
      ...
      <div className="mt-5 grid gap-3 md:grid-cols-3">
        {links.map((link) => (
          <Link
            key={link.href}
            href={link.href}
            className="rounded-2xl border border-white/10 bg-black/24 p-4 transition hover:border-[#8FB7FF]/36 hover:bg-white/[0.045]"
          >
