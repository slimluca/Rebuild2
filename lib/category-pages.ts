...
const seeds: CategorySeed[] = [
  ...
  },
  {
    ...
    compare: [
      "Whether hair-color filters feel accurate or only approximate in the live previews.",
    ...
    availability: "Hair-color data depends on what the live previews exposes, so the grid may use a best-available match and general live previews if exact matches are limited.",
  ...
  },
  {
    ...
    availability: "Region and appearance filters depend on profile data detail, so availability may broaden to general live previews when exact labels are not exposed.",
  ...
  },
  {
    ...
    availability: "Exact category matches can vary by live previews fields, so the grid uses the best available signals and live fallback behavior.",
  ...
  },
  {
    ...
    compare: [
      "Whether mature-style labels are profile data-provided, self-described, or inferred from limited profile details.",
  ...
  },
  {
    ...
    availability: "New model indicators depend on live previews data and can change as performers move through platform onboarding.",
  ...
  },
  {
    ...
    availability: "If the profile data does not expose a verified-only field, this page uses general live previews and explains verification as a platform signal to check at the destination.",
  ...
  },
  {
    ...
    availability: "Mobile stream signals depend on profile data data and platform player behavior, so use the grid as a current preview sample.",
  ...
  },
  {
    ...
    availability: "Mature category matching can vary by available profile fields and profile updates.",
  ...
  },
  {
    ...
    compare: [
      "Whether hair-color signals are exact, approximate, or unavailable in the profile data.",
  ...
  },
  {
    ...
    compare: [
      "Whether the profile data exposes relevant profile or category signals for accurate discovery.",
    ...
    availability: "profile data labels may be incomplete, so the page uses best-available live matches and general previews when needed.",
  ...
  },
  {
    ...
    intent: "Browse petite cam model previews while comparing live previews accuracy, mobile layout, profile detail, and signup comfort.",
    compare: [
  ...
  },
  {
    ...
    compare: [
      "Whether theme tags are supported by the live previews or need to be checked through platform filters.",
    ...
    availability: "Cosplay signals may not be exact in the profile data, so check live platform filters for the most current themed rooms.",
  ...
  },
  {
    ...
    compare: [
      "Whether interest tags appear in the profile data or need to be refined on the platform.",
  ...
  },
  {
    ...
    group: "Appearance-based categories",
    feedHint: "college",
    angle: "youthful-style category browsing with clear limits around live previews precision",
    ...
    availability: "College-style tags may not be exact in the profile data, so use this as a broad discovery page and confirm filters on the destination platform.",
  ...
  },
  {
    ...
    availability: "Regional matching depends on profile data country and language fields, so live results can broaden when exact details are missing.",
  ...
  },
  {
    ...
    availability: "Country signals may not always be present in the profile data, so this page uses best-available matching and general live previews.",
  ...
  },
  {
    ...
    compare: [
      "Whether the profile data exposes country or language data clearly enough for useful matching.",
  ...
  },
  {
    ...
    availability: "French matching uses best-available profile data signals and may fall back to general live previews.",
  ...
  },
  {
    ...
    compare: [
      "Whether Spanish language or country fields are available in the live previews.",
  ...
  },
  {
    ...
    availability: "Italian matches depend on live previews detail and may vary as rooms change status.",
  ...
  },
  {
    ...
    compare: [
      "Whether German country or language signals are exposed by the profile data.",
  ...
  },
  {
    ...
    compare: [
      "Whether Brazilian country or profile signals are available in the profile data.",
    ...
    availability: "Brazilian matching depends on live previews country data and can broaden to general previews when exact data is not present.",
  ...
  },
  {
    ...
    availability: "Fitness-style tags may be limited in the profile data, so related categories can help broaden discovery.",
  ...
  },
  {
    ...
    availability: "Conversation style is not always a structured available profile field, so use live platform filters for the most precise chat-focused browsing.",
  ...
  },
  {
    ...
    availability: "Language fields depend on live previews data and may change when models update profiles.",
  ...
  },
  {
    ...
    availability: "The profile data is not desktop-exclusive, so this page uses general live previews with desktop-focused decision guidance.",
  ...
  },
  {
    ...
    availability: "Tablet-specific profile data filters are not exact, so mobile stream signals and general live previews are used.",
  ...
  },
  {
    ...
    feedHint: "online-now",
    sortMode: "popular",
    angle: "current live availability without fixed rankings or unsupported online counts",
    ...
    compare: [
      "Which rooms are currently available through the live previews.",
  ...
  },
  {
    ...
    group: "Popular model categories",
    sortMode: "popular",
    angle: "popular-style browsing without unsupported rankings, stars, or traffic claims",
    ...
    compare: [
      "How active room status and stream quality can guide browsing without becoming a unsupported score.",
    ...
    availability: "This page does not claim fixed popularity numbers; it uses live previews signals as a current browsing aid.",
  ...
  },
  {
    ...
    group: "Popular model categories",
    sortMode: "quality",
    angle: "curated-feeling discovery based on live preview quality rather than unsupported editorial rankings",
  ...
  return {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "No. Live available profile fields vary by platform and model profile. WebcamSex.me uses the available live preview signals and avoids pretending a filter is exact when the data does not prove it.",
      },
      {
...
(["live-cam-models", "verified-cam-models"] as CategoryPageSlug[]).forEach(
  (slug) => {
    ...
    page.intro = [
      ...page.intro,
      "Use this category with the model category finder and related Best pages when live discovery is part of a broader platform decision. The goal is to compare current availability, platform filters, mobile layout, and signup comfort without pretending the profile data is a fixed database.",
    ];
    page.comparePoints = [
      ...page.comparePoints,
    ...
    page.safetyNote =
      `${page.safetyNote} Category pages do not invent model profiles, ratings, countries, or live status; they use the live preview source and explain that availability can change.`;
  },
);
